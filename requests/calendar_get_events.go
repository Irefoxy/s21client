...
type CalendarGetEvents_Data struct {
	CalendarEventS21 CalendarGetEvents_Data_CalendarEventS21 `json:"calendarEventS21"`
}

type CalendarGetEvents_Data_CalendarEventS21 struct {
...
type CalendarGetEvents_Data_Booking struct {
	...
	VerifierUser      CalendarGetEvents_Data_User              `json:"verifierUser"`
...
type CalendarGetEvents_Data_VerifiableStudent struct {
	ID       string                      `json:"id"`
	User     CalendarGetEvents_Data_User `json:"user"`
	Typename string                      `json:"__typename"`
}

type CalendarGetEvents_Data_User struct {
	ID       string `json:"id"`
	Login    string `json:"login"`
	Typename string `json:"__typename"`
}
