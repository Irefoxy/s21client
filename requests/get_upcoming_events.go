...
type GetUpcomingEvents_Variables struct {
	...
	RegistrationAccessStatusFilter string                           `json:"registrationAccessStatusFilter"`
	Page                           GetUpcomingEvents_Variables_Page `json:"page"`
}
...
type GetUpcomingEvents_Data struct {
	CalendarEventS21 GetUpcomingEvents_Data_CalendarEventS21 `json:"calendarEventS21"`
}

type GetUpcomingEvents_Data_CalendarEventS21 struct {
